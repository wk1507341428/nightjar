          ...
          methods: {
            ...
            play: function (t) {
              ...
              if (
                ...
                for (
                  var a = !1, o = t.target.id, s = this.root._videos.length;
                  s--;

                )
                  this.root._videos[s].id === o
                    ? (a = !0)
                    : this.root._videos[s].pause();
                if (!a) {
                  var n = wx.createVideoContext(o, this);
                  (n.id = o),
                    this.root.playbackRate &&
                      n.playbackRate(this.root.playbackRate),
            ...
            imgTap: function (t) {
              ...
              if (
                !e.attrs.ignore &&
                (this.root.triggerEvent("imgtap", e.attrs),
            ...
            linkTap: function (t) {
              var e = t.currentTarget
                  ? this.getNode(t.currentTarget.dataset.i)
                  : {},
                r = e.attrs || t,
                i = r.href;
            ...
            mediaError: function (t) {
              ...
              if ("video" === i.name || "audio" === i.name) {
                ...
                if ((a > i.src.length && (a = 0), a < i.src.length))
                  return this.setData(r({}, "ctrl." + e, a));
              } else
                "img" === i.name &&
